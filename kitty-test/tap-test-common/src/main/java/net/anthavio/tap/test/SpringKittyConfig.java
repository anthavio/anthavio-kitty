...
import net.anthavio.kitty.KittyOptions;
import net.anthavio.spring.ssl.JksSslSocketFactory;
import net.anthavio.spring.ws.HttpClient4Sender;
...
@ComponentScan(basePackages = "net.anthavio.tap.test", excludeFilters = @ComponentScan.Filter(Configuration.class))
public class SpringKittyConfig {
	...
	public Jaxb2Marshaller messagesJaxb2Marshaller() {
		...
		marshaller.setContextPath(net.anthavio.example.messages.ObjectFactory.class.getPackage().getName());
